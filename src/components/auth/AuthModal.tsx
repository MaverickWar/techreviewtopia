      ...
      <DialogContent className="sm:max-w-[900px] p-0 overflow-hidden">
        <div className="grid grid-cols-1 md:grid-cols-5 h-[600px]">
          ...
          <div className="relative col-span-2 hidden md:block">
            <img src="https://images.unsplash.com/photo-1487058792275-0ad4aaf24ca7" alt="Featured Tech" className="h-full w-full object-cover" />
          ...
          <div className="col-span-3 p-8">
            <AuthForm mode={mode} onModeChange={setMode} onClose={onClose} />
          </div>
        </div>
      </DialogContent>
    </Dialog>;
